...
mv "../../data/request_get_180_consumptions.csv" "../../data/80MB/A1/"
mv "../../data/request_get_80_consumptions.csv" "../../data/80MB/A1/"
mv "../../data/request_post_80_create_water_consumption.csv" "../../data/80MB/A1/"
mv "../../data/request_post_180_create_water_consumption.csv" "../../data/80MB/A1/"
cd -
sh "./delete_eds.sh"
