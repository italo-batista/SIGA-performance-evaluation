...
mv "../../data/request_get_180_consumptions.csv" "../../data/$1B/$2/"
mv "../../data/request_get_80_consumptions.csv" "../../data/$1B/$2/"
mv "../../data/request_post_80_create_water_consumption.csv" "../../data/$1B/$2/"
mv "../../data/request_post_180_create_water_consumption.csv" "../../data/$1B/$2/"
cd -
sh "./delete_eds.sh"
