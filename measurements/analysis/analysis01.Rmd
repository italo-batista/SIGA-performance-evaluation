...
experimentos = c('I1', 'I2', 'I3', 'I4', 'A1', 'A2', 'A3', 'A4', 'A5')

for (e in experimentos) {
  
  path_80mb = paste("../data/80MB/", e, sep="")
  path_500mb = paste("../data/500MB/", e, sep="")
  path_1gb = paste("../data/1GB/", e, sep="")
  ...
  get.80.80m = read.csv2(file=paste(path_80mb, "/request_get_80_consumptions.csv", sep=""), sep = ",")
  get.180.80m = read.csv2(file=paste(path_80mb, "/request_get_180_consumptions.csv", sep=""), sep=",")
  post.80.80m = read.csv2(file=paste(path_80mb, "/request_post_80_create_water_consumption.csv", sep=""), sep=",")
  post.180.80m = read.csv2(file=paste(path_80mb, "/request_post_180_create_water_consumption.csv", sep=""), sep=",")
...
```{r fig.height=7}
ggplot(data=requests.all, aes(x=as.factor(RAM), y=log10(TIMESTAMP), colour=as.factor(REQ_MIN))) + 
  geom_boxplot() +
